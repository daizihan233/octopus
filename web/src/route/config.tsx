...
const Monitor_Module = lazyWithPreload(() => import('@/components/modules/monitor').then(m => ({ default: m.Monitor })));
...
export const ROUTES: RouteConfig[] = [
    ...
    { id: 'monitor', label: 'Monitor', icon: Activity, component: Monitor_Module },
